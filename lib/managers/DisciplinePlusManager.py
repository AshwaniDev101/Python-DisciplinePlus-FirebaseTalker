...
class DisciplinePlusManager:
    def __init__(self):
        ...
        firebase_service_account_key_path = "firebase/key/firebase-discipline-plus-serviceAccountKey.json"
    ...
    def upload_excel_to_firebase(self):
        ...
        for weekday_name in self.weekday_name_list:
            ...
            self.firebase_manger.upload_initiative_list_to_firebase(weekday_name=weekday_name, initiative_list=initiative_list)
